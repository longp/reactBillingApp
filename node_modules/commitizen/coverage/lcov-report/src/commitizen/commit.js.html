...
function commit(sh, inquirer, repoPath, prompter, options, done) {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if(options.retryLastCommit) <span class="cstat-no" title="statement not covered" ><span class="cstat-no" title="statement not covered" ><span class="cstat-no" title="statement not covered" ><span class="cstat-no" title="statement not covered" >{</span></span></span></span>
