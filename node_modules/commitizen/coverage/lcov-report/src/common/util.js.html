 ...
 */
function getParsedJsonFromFile(filePath, fileName, encoding = </span>'utf8') <span class="branch-1 cbranch-no" title="branch not covered" ><span class="branch-1 cbranch-no" title="branch not covered" >{</span>
  try {
